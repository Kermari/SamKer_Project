...
<body>
    ...
    <div>
        ...
        <div>
            <label>Title</label>
            <textarea name="title" maxlength="255">{{old('title', $note->title)}}</textarea>
        </div>

        <div>
            <label>Description</label>
            <textarea name="description" maxlength="255" placeholder="Brief excerpt...">{{old('description', $note->description)}}</textarea>
        </div>

        <div>
            <label>Content</label>
            <textarea name="content" maxlength="10000" placeholder="Write something here...">{{old('content', $note->content)}}</textarea>
        </div>


        <div> <!-- Button to go to edit note.-->
